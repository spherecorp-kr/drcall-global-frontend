...
export const mockMonthlyWeightData: MonthlyWeightPhrResponse = {
	period: {
		year: 2025,
		month: 1,
		monthName: 'm01',
...
// 월간 혈압 샘플 데이터
export const mockMonthlyPressureData: MonthlyPressurePhrResponse = {
	period: {
		year: 2025,
		month: 1,
		monthName: 'm01',
...
// 월간 혈당 샘플 데이터
export const mockMonthlySugarData: MonthlySugarPhrResponse = {
	period: {
		year: 2025,
		month: 1,
		monthName: 'm01',
...
// 월간 체온 샘플 데이터
export const mockMonthlyTempData: MonthlyTempPhrResponse = {
	period: {
		year: 2025,
		month: 1,
		monthName: 'm01',
