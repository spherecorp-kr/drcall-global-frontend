const CancelInfo = () => {
	return (
		<div className="flex flex-1 flex-col gap-2.5 items-start self-stretch">
			<h2 className='font-semibold leading-[normal] text-text-100 text-xl'>예약 취소 정보</h2>
			<div className='bg-white border border-stroke-input flex p-5 rounded-[0.625rem] w-full'>
				<div className='flex flex-1 flex-col gap-4 items-start'>
					<div className='flex gap-2.5 items-center justify-start w-full'>
						<p className='leading-[normal] text-base text-text-70 w-[12.5rem]'>예약 번호</p>
						<p className='leading-[normal] text-base text-text-100'>123456789</p>
					</div>
					<div className='flex gap-2.5 items-center justify-start w-full'>
						<p className='leading-[normal] text-base text-text-70 w-[12.5rem]'>취소자</p>
						<p className='leading-[normal] text-base text-text-100'>병원</p>
					</div>
				</div>
				<div className='flex flex-1 flex-col gap-4 items-start'>
					<div className='flex gap-2.5 items-center justify-start w-full'>
						<p className='leading-[normal] text-base text-text-70 w-[12.5rem]'>예약 취소 일시</p>
					...
					<div className='flex gap-2.5 items-start justify-start w-full'>
						<p className='leading-[normal] text-base text-text-70 w-[12.5rem]'>취소 사유</p>
						<textarea
