...
const BUTTON_CLASS: string = 'active:bg-white active:border-primary-90 bg-white border border-primary-70 disabled:bg-bg-disabled disabled:border-text-20 disabled:text-text-20 gap-1.5 h-10 hover:bg-bg-blue rounded-sm text-primary-70';
					...
					icon={
						...
						>
							<path
								...
								fill={payCheckAvailable ? '#00a0d2' : '#d5d5d5'}
							/>
						</svg>
					}
				>입금 확인</Button>
					...
					icon={
						...
						>
							<path
								...
								stroke={reAppointmentAvailable ? '#00a0d2' : '#d5d5d5'}
								strokeLinecap="round"
