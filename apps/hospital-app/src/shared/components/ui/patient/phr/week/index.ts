...
export { default as WeeklyPressure } from './BloodPressure';
export { default as WeeklySugar } from './BloodSugar';
export { default as WeeklyTemp } from './Temperature';
export { default as WeeklyWeight } from './Weight';

// 주간 체중 샘플 데이터
export const sampleWeeklyWeightData: WeeklyWeightPhrResponse = {
	period: {
...
// 주간 혈압 샘플 데이터
export const sampleWeeklyPressureData: WeeklyPressurePhrResponse = {
	period: {
...
// 주간 혈당 샘플 데이터
export const sampleWeeklySugarData: WeeklySugarPhrResponse = {
	period: {
		startDate: '2025-01-13',
		endDate: '2025-01-19',
...
// 주간 체온 샘플 데이터
export const sampleWeeklyTempData: WeeklyTempPhrResponse = {
	period: {
		startDate: '2025-01-13',
		endDate: '2025-01-19',
		monthName: '1월',
