...
interface HeightWeightFormData {
  recordedAt: string;
  height: string;
  weight: string;
}

interface HeightWeightFormProps {
  onSubmit: (data: HeightWeightFormData) => void;
  isSubmitting: boolean;
  onPickerStateChange?: (isOpen: boolean) => void;
  onShowToast?: (message: string) => void;
}

export default function HeightWeightForm({
  onSubmit,
  isSubmitting,
  onPickerStateChange,
  onShowToast,
}: HeightWeightFormProps) {
          ...
          <div style={{ paddingTop: '0.5rem', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ paddingTop: '0.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
                ...
                />
                <span style={{ flex: 1, textAlign: 'right', color: '#C1C1C1', fontSize: '1rem', fontFamily: 'Pretendard', fontWeight: '400' }}>
                  kg
                </span>
              </div>
