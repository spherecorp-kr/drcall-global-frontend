...
export const mockChatService = {
  ...
  createChannel: async (
    ...
    const newChannel: ChatChannel = {
      ...
      members: request.userIds.map(id =>
  ...
  sendMessage: async (
    ...
    if (
      ...
      request.user_id.startsWith('patient-')
    ) {
...
export { isSystemMessage, isChannelClosed, formatMessageTime, formatMessageDate, isSameDay } from './chatService';
