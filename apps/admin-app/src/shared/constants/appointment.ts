...
/**
 * Canceller Type (for hospital app)
 */
export const CancellerType = {
  HOSPITAL: 'HOSPITAL',
  PATIENT: 'PATIENT',
  SYSTEM: 'SYSTEM',
} as const;

export type CancellerTypeValue = typeof CancellerType[keyof typeof CancellerType];

export const CancellerTypeI18nKey: Record<CancellerTypeValue, string> = {
  [CancellerType.HOSPITAL]: 'appointment.canceller.hospital',
  [CancellerType.PATIENT]: 'appointment.canceller.patient',
  [CancellerType.SYSTEM]: 'appointment.canceller.system',
};
...
/**
 * Helper function to get i18n key for canceller type
 */
export const getCancellerTypeI18nKey = (type: CancellerTypeValue): string => {
  return CancellerTypeI18nKey[type];
};
...
export const StatusMapper = {
  waiting: AppointmentStatus.PENDING,
