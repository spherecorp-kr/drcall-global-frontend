...
const variantStyles: Record<ButtonVariant, string> = {
	...
	outline:
		'border border-primary-70 !text-primary-70 bg-bg-white hover:bg-bg-blue active:bg-bg-white active:border-primary-90 disabled:border-stroke-input disabled:!text-text-20 disabled:bg-bg-disabled',
	ghost: 'border border-stroke-input !text-text-100 bg-bg-white hover:bg-bg-gray active:bg-bg-white active:border-text-90 disabled:border-stroke-input disabled:bg-bg-disabled',
};
